...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TurEkle.aspx.cs" Inherits="TurEkle" %>
    ...
    <form id="form1" runat="server">
        <nav class="navbar navbar-default" role="navigation">
         ...
         <div style="width:200px;height:200px;margin:0 auto;">
            <asp:TextBox ID="txtTurAdi" runat="server" class="form-control"></asp:TextBox>
            <asp:TextBox ID="txtKTurAciklama" runat="server" class="form-control" 
